...
@section('content')
    ...
    <div class="container">
        <div class="row justify-content-center">
            <div class="col-md-8">
                <div class="card">
                    <div class="card-header">{{ __('Registracija za dresera') }}</div>

                    <div class="card-body">
                        <form class="form-horizontal" role="form" method="POST" action="{{ url('/trainer_register') }}">
                                @csrf
                                ...
                                <div class="form-group row">
                                    <label for="exp" class="col-md-4 col-form-label text-md-right">{{ __('Vaše iskustvo sa dresurom') }}</label>

                                    <div class="col-md-6">
                                        <input id="exp" type="text" class="form-control{{ $errors->has('exp') ? ' is-invalid' : '' }}" name="description" value="{{ old('name') }}" required autofocus>
